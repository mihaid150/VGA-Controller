...
HD_PWD='C:/Users/Mihai/Desktop/VGA/Code/Vivado/VGA_Controller/VGA_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaDriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vgaDriver.tcl -notrace
